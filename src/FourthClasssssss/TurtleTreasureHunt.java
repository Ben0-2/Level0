...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
        ...
        JOptionPane.showMessageDialog(null, tortoiseLocationX +", " + tortoiseLocationY);
        ...
        if(tortoiseLocationX==505 && tortoiseLocationY<=345 && tortoiseLocationY>=295){
        JOptionPane.showMessageDialog(null, "Go to Dory the dumb blue fish");	
        }
		// 7. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, e
   		if(tortoiseLocationX==325 && tortoiseLocationY == 410){
			JOptionPane.showMessageDialog(null, "Go to the TNT Blowy uppie thingie");
		}
	    if(tortoiseLocationX == 110 && tortoiseLocationY == 310){
	    	Tortoise.explode();
	    	JOptionPane.showMessageDialog(null, "You won!!!!! and in the treasure you found.......");
	    	playVideo("https://www.youtube.com/watch?v=wZZ7oFKsKzY");
	    	JOptionPane.showMessageDialog(null, "NYAN CATTTTT!!");
