...
public class ShapMaker {
	...
	String hi = JOptionPane.showInputDialog("what spiral bruh? sides 3-8");
		// 5. Set the number of sides depending on what the user entered (multiple lines of code)
		double bla = Double.parseDouble(hi);
		
		
		
		// 6. If the user enters something else, say "Sorry, I don't know how to draw a ..."
	   if (bla <3 || bla > 8 ){
		   JOptionPane.showMessageDialog(null, "Srry, me no know how to draw " + bla + "-sided shape.");
	   System.exit(0);
	   }
